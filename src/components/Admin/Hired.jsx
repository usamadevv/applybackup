...
const [users, setusers] = useState([])
    ...
    const [sele, setsele] = useState('job')
     ...
     <div className="subadduser">   <h1>Add User</h1>
      ...
      <div className="headeradmin">
                    <div className="priormenu">
                        ...
                        <p>Hired Job Seekers & Contractor Management</p>
                    </div>
                    <img src={user} alt="" />
            ...
            <>     
            <div className="max90">
                <button className={`${sele==='cont'?'purp':''}`} onClick={e=>setsele('cont')}>Contractor</button>
                <button  className={`${sele==='job'?'purp':''} bord`}  onClick={e=>setsele('job')} >Job Seekers</button>
            </div>
                   <div className="tablebox nomar">
